                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "GetCMEWebAPI").Description("A web api for a CME data service");
                        ...
                        //
                        c.IncludeXmlComments(string.Format(@"{0}\bin\GetCMEWebAPI.XML", System.AppDomain.CurrentDomain.BaseDirectory));
